...
const {CarritosDao} = require('../DAO/index.js');
const {cartsSchema} = require ('../DAO/schemas/mongoSchemas.js');



// class Productos extends ContenedorMongo{ 
class Carritos extends CarritosDao{ 
    constructor() {
        super(cartsSchema,'carts');//productsSchema,'products' se carga la informacion de productos desde Mongo
    }
}
