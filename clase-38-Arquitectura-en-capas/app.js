...
const apiProductosRouter = require('./src/routes/routeProducts.js')
const apiCartsRouter = require('./src/routes/routeCarts.js')
const apiMessagesRouter = require('./src/routes/routeMessages.js')
const infoRouter = require('./src/routes/routeInfo.js')
const viewsRouter = require('./src/routes/routeViews.js')
...
const {usersSchema} = require('./src/config/config.js');
const bcrypt = require('bcrypt-nodejs')
const transport = require('./src/libs/nodemailer.js')
const log4js = require('./src/libs/log4js.js');
